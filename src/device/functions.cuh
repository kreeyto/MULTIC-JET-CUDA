...
__device__ __forceinline__ float gpuComputeTensor2(float XX, float YY, float ZZ, float XY, float XZ, float YZ, int Q) {
...
__device__ __forceinline__ float gpuComputeFeq(float rho, float ux, float uy, float uz, float uu, int Q) {
